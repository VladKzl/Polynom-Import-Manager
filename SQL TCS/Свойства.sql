...
;with tree(nm, id,pid, lvl,path1,path2) 
    ...
    select distinct par.PAR_NOTE NAME, PAR.PAR_UNQ CODE,par.PAR_TYPE TYPE,'' MEASUREENTITY
...
left join PAR_LIST l on l.PAR_ID=PAR.PAR_ID  
order by path2, par.PAR_NOTE